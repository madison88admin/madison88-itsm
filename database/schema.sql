...
CREATE TABLE IF NOT EXISTS TICKETS (
    ...
    CATEGORY VARCHAR(100) NOT NULL CHECK (CATEGORY IN ('Hardware', 'Software', 'Access Request', 'Account Creation', 'Onboarding', 'Network', 'Other')),
...
-- Ticket Escalations Indexes
CREATE INDEX IDX_ESCALATIONS_TICKET_ID ON TICKET_ESCALATIONS(TICKET_ID);

CREATE INDEX IDX_ESCALATIONS_STATUS ON TICKET_ESCALATIONS(STATUS);
